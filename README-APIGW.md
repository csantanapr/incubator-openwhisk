### OpenWhisk API Gateway Experimental
...
```
wsk api-experimental create -b /api/test/v1 /echo get /whisk.system/utils/echo
ok: created api /echo GET for action /whisk.systems/utils/echo
http://192.168.33.13:9001/api/45baceb8-d106-4879-929a-ad2649bb1df1/api/test/v1/echo
```
...
```
curl -X GET http://192.168.33.13:9001/api/45baceb8-d106-4879-929a-ad2649bb1df1/api/test/v1/echo?bark=woof
{
 "bark":"woof"
}
```
...
Deploy the apigateway after whisk is running locally
```
cd ansible
ansible-playbook -i environments/mac apigateway.yml
```
...
```
$ wsk api-experimental create -n "Santana Bank" /bank /checks get /whisk.system/utils/echo
ok: created api /checks GET for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/checks
$ wsk api-experimental create -n "Santana Bank" /bank /checks post /whisk.system/utils/echo
ok: created api /checks POST for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/checks
$ wsk api-experimental create -n "Santana Bank" /bank /checks put /whisk.system/utils/echo
ok: created api /checks PUT for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/checks
$ wsk api-experimental create -n "Santana Bank" /bank /checks delete /whisk.system/utils/echo
ok: created api /checks DELETE for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/checks
$ wsk api-experimental create -n "Santana Bank" /bank /accounts post /whisk.system/utils/echo
ok: created api /accounts POST for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/accounts
$ wsk api-experimental create -n "Santana Bank" /bank /accounts delete /whisk.system/utils/echo
ok: created api /accounts DELETE for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/accounts
$ wsk api-experimental create -n "Santana Bank" /bank /accounts get /whisk.system/utils/echo
ok: created api /accounts GET for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/accounts
$ wsk api-experimental create -n "Santana Bank" /bank /accounts put /whisk.system/utils/echo
...
```
$ wsk api-experimental list /bank
ok: apis
Action                           Verb             API Name  URL
whisk.system/utils/echo           get         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
whisk.system/utils/echo          post         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
...
```
$ wsk api-experimental list "Santana Bank"
ok: apis
Action                           Verb             API Name  URL
whisk.system/utils/echo           get         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
whisk.system/utils/echo          post         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
...
```
$ wsk api-experimental list /bank /checks
ok: apis
Action                           Verb             API Name  URL
whisk.system/utils/echo           get         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
whisk.system/utils/echo          post         Santana Bank  http://21ef035.api-gw.mybluemix.net/bank/checks
...
```
$ wsk api-experimental get "Santana Bank" > bank-swagger.json
$ vi bank-swagger.json
```
Let's test the swagger file by deleting the API name `Santana Bank`
```
$ wsk api-experimental delete "Santana Bank"
...
```
$ wsk api-experimental create --config-file bank-swagger.json
ok: created api /accounts delete for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/accounts
ok: created api /accounts get for action utils/echo
http://21ef035.api-gw.mybluemix.net/bank/accounts
...
```
$ wsk api-experimental get "Santana Bank"
{
    "swagger": "2.0",
    "basePath": "/bank",
    "info": {
